...
export function Login() {
  ...
  const { signIn, signInWithOAuth, signInWithAuth0 } = useAuth();
  ...
  const handleOAuthLogin = async (provider: 'google' | 'github') => {
    ...
    try {
      ...
      console.log('🔐 Starting Supabase OAuth with redirect to:', redirectTo);
  ...
  const handleAuth0Login = async (connection?: 'google-oauth2' | 'github') => {
    setError('');
